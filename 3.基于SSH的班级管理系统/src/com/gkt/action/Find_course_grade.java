...
public class Find_course_grade extends ActionSupport
{
	...
	private List<Classunit> classno;
	private Classunit classo;
	...
	public Classunit getClasso()
	{
		return classo;
	}

	public void setClasso(Classunit classo)
	{
		this.classo = classo;
	}
	...
	public List<Classunit> getClassno()
	{
		return classno;
	}

	public void setClassno(List<Classunit> classno)
	{
...
//		{
			...
			{
				courseo=courseService.findByno(getCourseStr());			
				grade=gradeService.findByCourse(courseo);
				
				classNum="全部";
				courseNum=courseo.getCourseNumber();
				courseStr=courseo.getCourseName();			
			}
			...
			{	
				...
				courseNum="全部";
				classNum=classo.getClassNumber();
				classStr=classo.getClassName();
			}
			else
			{
				courseo=courseService.findByno(courseStr);
				classo=classService.findByno(getClassStr());			
				grade=gradeService.findByCourseAndClass(courseo,classo);
