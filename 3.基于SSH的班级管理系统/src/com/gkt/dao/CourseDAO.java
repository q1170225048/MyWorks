...
public class CourseDAO extends HibernateDaoSupport {
	...
	public boolean checkCoursenumber(String coursenumber)
	{
		...
		{
			Course cun = findById(coursenumber);
			if(cun == null)
			{
				return false;
			}
	...
	public List<Course> findByCourseType(Object courseType) {
		return findByProperty(COURSE_TYPE, courseType);
	}

	public List<Course> findByCourseGrade(Object courseGrade) {
