      ...
      <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">班级管理<small> > 信息修改</small></h1>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                String classnumber=request.getParameter("classnumber");
                                 %>
                                    <form role="form" action="ClassEditAction" method="post">
                                        <!-- <fieldset disabled=""> -->
                                            <div class="form-group">
                                                <label for="disabledSelect">班级编号</label>
                                                <input name="classunitnumber" class="form-control" id="disabledInput" readonly="true" value="<%=classnumber%>">
                                            </div>
                                        <!-- </fieldset> -->
                                        <div class="form-group">
                                                <label for="disabledSelect">班级名称</label>
                                                <input name="classunitname" class="form-control" placeholder="请输入希望修改的班级名称">
                                            </div>
