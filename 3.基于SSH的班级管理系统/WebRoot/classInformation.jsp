...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">班级管理<small> > 班级信息</small></h1>
                    </div>
                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><div align='center'>班级编号</th>
                                            <th><div align='center'>班级名称</th>
                                            <th><div align='center'>相关操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <!-- 列表传值 -->
                                        <s:iterator value="classunit" id="id" status="status">
                                        <tr class="odd gradeX">
                                            <th><div align='center'><s:property value="%{#status.count}"/></th>
			                                <th><div align='center'><s:property value="classNumber"/></div></th>		
			                                <th><div align='center'><s:property value="className"/></div></th>
			                                <th><div align='center'><button class="btn btn-primary" onclick="edit(<s:property value="classNumber"/>)"><i class="fa fa-edit "></i> 修改</button>&nbsp;<button class="btn btn-danger" onclick="del(<s:property value="classNumber"/>)"><i class="fa fa-pencil"></i> 删除</button></div></th>
		                                </tr>
                                        </s:iterator>
	...
	function edit(classNumber){
	    window.location.href='classEdit.jsp?classnumber='+classNumber+'';
	};
	
	function del(classNumber){
	    if(confirm("确定删除此条数据？")){
			window.location.href='ClassDelAction.action?classunitnumber='+classNumber+'';
		}
		return false;
	};
