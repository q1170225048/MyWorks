      ...
      <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">课程管理<small> > 信息修改</small></h1>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                String coursenumber=request.getParameter("coursenumber");
                                 %>
                                    <form role="form" action="CourseEditAction" method="post">
                                        <!-- <fieldset disabled=""> -->
                                            <div class="form-group">
                                                <label for="disabledSelect">课程编号</label>
                                                <input name="coursenumber" class="form-control" id="disabledInput" readonly="true" value="<%=coursenumber%>">
                                            </div>
                                            <!-- </fieldset> -->
                                            <div class="form-group">
                                                <label for="disabledSelect">课程名称</label>
                                                <input name="coursename" class="form-control" placeholder="请输入希望修改的课程名称">
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledSelect">课程性质</label>
                                                <input name="coursetype" class="form-control" placeholder="请输入希望修改的课程性质">
                                            </div>
                                            <div class="form-group">
                                                <label for="disabledSelect">学分</label>
                                                <input name="coursegrade" class="form-control" placeholder="请输入希望修改的课程学分">
                                            </div>
