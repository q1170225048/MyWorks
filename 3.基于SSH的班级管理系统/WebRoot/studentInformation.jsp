...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">学生管理<small> > 学生信息</small></h1>
                    </div>
                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><div align='center'>性别</th>
                                            <th><div align='center'>出生年月</th>
                                            <th><div align='center'>电话</th>
                                            <th><div align='center'>家庭地址</th>
                                            <th><div align='center'>所在班级</th>
                                            <th><div align='center'>相关操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <!-- 列表传值 -->
                                        <s:iterator value="student" id="id" status="status">
                                        <tr class="odd gradeX">
                                            <th><div align='center'><s:property value="%{#status.count}"/></th>
			                                <th><div align='center'><s:property value="studentNumber"/></div></th>		
			                                <th><div align='center'><s:property value="studentName"/></div></th>
			                                <th><div align='center'><s:property value="studentGender"/></div></th>		
			                                <th><div align='center'><s:property value="studentBirth"/></div></th>
			                                <th><div align='center'><s:property value="studentPhone"/></div></th>		
			                                <th><div align='center'><s:property value="studentAddress"/></div></th>
			                                <th><div align='center'><s:property value="classunit.classNumber"/></div></th>
			                                <th><div align='center'><button class="btn btn-primary" onclick="edit(<s:property value="studentNumber"/>)"><i class="fa fa-edit "></i> 修改</button>&nbsp;<button class="btn btn-danger" onclick="del(<s:property value="studentNumber"/>)"><i class="fa fa-pencil"></i> 删除</button></div></th>
		                                </tr>
                                        </s:iterator>
	...
	function edit(studentNumber){
	    window.location.href='studentEdit.jsp?studentnumber='+studentNumber+'';
	};
	
	function del(studentNumber){
	    if(confirm("确定删除此条数据？")){
			window.location.href='StudentDelAction.action?studentnumber='+studentNumber+'';
		}
		return false;
	};
