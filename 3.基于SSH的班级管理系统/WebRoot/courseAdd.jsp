      ...
      <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">课程管理<small> > 新增课程</small></h1>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    <form role="form" action="CourseAddAction" method="post">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="inputSuccess">请输入课程编号</label>
                                            <input name="coursenumber" type="text" class="form-control" id="inputSuccess">
                                        </div>
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">请输入课程名称</label>
                                            <input name="coursename" type="text" class="form-control" id="inputWarning">
                                        </div>
                                        <div class="form-group has-success">
                                            <label class="control-label" for="inputSuccess">请输入课程性质</label>
                                            <input name="coursetype" type="text" class="form-control" id="inputSuccess">
                                        </div>
                                        <div class="form-group has-warning">
                                            <label class="control-label" for="inputWarning">请输入课程学分</label>
                                            <input name="coursegrade" type="text" class="form-control" id="inputWarning">
                                        </div>
