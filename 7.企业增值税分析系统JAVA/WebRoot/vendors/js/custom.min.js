...
function InPur(){
	...
	var itemHtml=["<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
              		"<span class='count_top'><i class='fa fa-align-left'></i> 第 1 月</span>",
              		"<div class='count'>"+data1[1]+"</div>",
	...
	for(var i=2;i<=12;i++)
	{
		...
		{
			var Percentage=Math.round(((data1[i]-data1[i-1])/data1[i-1])*10000) / 100.00 + "%"
			//alert(data1[i]+data1[i-1]);
			itemHtml=["<div class='col-md-2 col-sm-4 col-xs-8 tile_stats_count'>",
		            		"<span class=count_top><i class='fa fa-align-left'></i> 第 "+i+" 月</span>",
		            		"<div class=count>"+data1[i]+"</div>",
		            		"<span class=count_bottom><i class=green><i class='fa fa-sort-asc'></i>"+Percentage+" </i> 上月相比</span>",
		             "</div>"
		             ].join('\n');
		}
		else
		{
			var Percentage=Math.round(((data1[i-1]-data1[i])/data1[i-1])*10000) / 100.00 + "%"
			itemHtml=["<div class='col-md-2 col-sm-4 col-xs-8 tile_stats_count'>",
	            		"<span class=count_top><i class='fa fa-align-left'></i> 第 "+i+" 月</span>",
	            		"<div class=count>"+data1[i]+"</div>",
	            		"<span class=count_bottom><i class=red><i class='fa fa-sort-desc'></i>"+Percentage+" </i> 上月相比</span>",
	             "</div>"
	             ].join('\n');
		}
		$("#test").append(itemHtml);
...
function inp()
{
	$("#test3").html("");
	var itemHtml=["<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
          		"<span class='count_top'><i class='fa fa-align-left'></i> 年进项总额</span>",
        		"<div class='count'>"+data3["sum"]+"</div>",
        		"<span class='count_bottom'><i class='green'> </i> </span>",
        		"</div>"
        	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
        		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["maxmonth"]+"月 </span>",
      		"<div class='count'><i class='green'>"+data3["max"]+"</i> </div>",
      		"<span class='count_bottom'>进项最高月</span>",
      		"</div>"
      	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
      		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["minmonth"]+"月 </span>",
    		"<div class='count'><i class='red'>"+data3["min"]+"</i> </div>",
    		"<span class='count_bottom'>进项最低月</span>",
    		"</div>"
    	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
      		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["fmonth"]+"月增长 </span>",
    		"<div class='count'><i class='green'>"+data3["fastd"]+"</i> </div>",
    		"<span class='count_bottom'>相比上月增长最多</span>",
    		"</div>"
    	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
      		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["decremonth"]+"月减少</span>",
    		"<div class='count'><i class='red'>"+data3["decre"]+"</i> </div>",
    		"<span class='count_bottom'>相比上月减少最多</span>",
    		"</div>"
    	 ].join('\n');
	$("#test3").append(itemHtml);
}
function outp()
{
	$("#test4").html("");
	var itemHtml=["<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
          		"<span class='count_top'><i class='fa fa-align-left'></i> 年销项总额</span>",
        		"<div class='count'>"+data3["sum2"]+"</div>",
        		"<span class='count_bottom'><i class='green'> </i> </span>",
        		"</div>"
        	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
        		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["maxmonth2"]+"月 </span>",
      		"<div class='count'><i class='green'>"+data3["max2"]+"</i> </div>",
      		"<span class='count_bottom'>销项最高月</span>",
      		"</div>"
      	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
      		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["minmonth2"]+"月 </span>",
    		"<div class='count'><i class='red'>"+data3["min2"]+"</i> </div>",
    		"<span class='count_bottom'>销项最低月</span>",
    		"</div>"
    	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
      		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["fmonth2"]+"月增长</span>",
    		"<div class='count'><i class='green'>"+data3["fastd2"]+"</i> </div>",
    		"<span class='count_bottom'>相比上月增长最多</span>",
    		"</div>"
    	 ].join('\n');
	itemHtml=[itemHtml,"<div class='col-md-2 col-sm-4 col-xs-10 tile_stats_count'>",
      		"<span class='count_top'><i class='fa fa-align-left'></i>第"+data3["decremonth2"]+" 月减少</span>",
    		"<div class='count'><i class='red'>"+data3["decre2"]+"</i> </div>",
    		"<span class='count_bottom'>相比上月减少最多</span>",
    		"</div>"
    	 ].join('\n');
	$("#jxz").html("");
	$("#jxz").append("<div class='count'>"+data3["sum"]+"</div>");
	$("#xxz").html("");
	$("#xxz").append("<div class='count'>"+data3["sum2"]+"</div>");
	$("#test4").append(itemHtml);
}
//销项数据的分析
function OutSale()
{
	...
	for(var i=2;i<=12;i++)
	{
		...
		{
			var Percentage=Math.round(((data2[i]- data2[i-1])/data2[i-1])*10000) / 100.00 + "%"
			//alert(data1[i]+data1[i-1]);
			itemHtml=["<div class='col-md-2 col-sm-4 col-xs-8 tile_stats_count'>",
		            		"<span class=count_top><i class='fa fa-align-left'></i> 第 "+i+" 月</span>",
		            		"<div class=count>"+data2[i]+"</div>",
		            		"<span class=count_bottom><i class=green><i class='fa fa-sort-asc'></i>"+Percentage+" </i> 上月相比</span>",
		             "</div>"
		             ].join('\n');
		}
		...
		{
			var Percentage=Math.round(((data2[i-1]-data2[i]) /data2[i-1])*10000) / 100.00 + "%"
			itemHtml=["<div class='col-md-2 col-sm-4 col-xs-8 tile_stats_count'>",
	            		"<span class=count_top><i class='fa fa-align-left'></i> 第 "+i+" 月</span>",
	            		"<div class=count>"+data2[i]+"</div>",
	            		"<span class=count_bottom><i class=red><i class='fa fa-sort-desc'></i>"+Percentage+" </i> 上月相比</span>",
		...
		$("#any").html("");
		$("#any").append("<p><h2>由有限的数据分析可得:进项最高月为"+data3["maxmonth"]+"月,最低月为"+data3["minmonth"]+"月,增长最快为第"+data3["fmonth"]+"月,下降最快为第"+data3["decremonth"]+"月;销项最高月为"+data3["maxmonth2"]+"月,最低月为"+data3["minmonth2"]+"月,增长最快为第"+data3["fmonth2"]+"月,下降最快为第"+data3["decremonth2"]+"月.</h2><br><h1>结果预测:</h1><br><h2>每年的第"+data3["fmonth"]+"月可能会出现资金短缺,需要注意销售市场的开拓;每年的第"+data3["fmonth2"]+"月可能是资金最充足的,可能需要注意供货的充足;预计明年的第"+data3["maxmonth"]+","+data3["maxmonth2"]+"月将是需求量较大,需要在月初进行税收的筹划,而在第"+data3["fmonth"]+"，"+data3["fmonth2"]+"月需要密切注意资金流动。</h2>");
		$("#test2").append(itemHtml);
	}
}
...
$(document).ready(function(){outp(),inp(),InPur(),OutSale(),init_sparklines(),init_flot_chart(),init_sidebar(),init_wysiwyg(),init_InputMask(),init_JQVmap(),init_cropper(),init_knob(),init_IonRangeSlider(),init_ColorPicker(),init_TagsInput(),init_parsley(),init_daterangepicker(),init_daterangepicker_right(),init_daterangepicker_single_call(),init_daterangepicker_reservation(),init_SmartWizard(),init_EasyPieChart(),init_charts(),init_morris_charts(),init_skycons(),init_select2(),init_validator(),init_DataTables(),init_chart_doughnut(),init_gauge(),init_PNotify(),init_starrr(),init_calendar(),init_compose(),init_CustomNotification(),init_autosize(),init_autocomplete()});