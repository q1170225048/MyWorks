                                ...
                                <div class="bs_navleft">
                                    <li>
                                       ...
                                       session.getAttribute("existUser");
                                        %>
                                        </span>您好！${sessionScope.existUser.name} 今天是
                                        <script>
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmleft name=frmleft src=<%="leftPages/accordition.jsp" %> allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" height="100%" width="100%" frameBorder=0 id=frmright name=frmright src=<%="shouye/shouye_gl.jsp"%> allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
